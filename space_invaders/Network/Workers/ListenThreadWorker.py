        ...
        while True:
            try:
                ...
                if flag == "NEW CLIENT":
                    ...
                    print(f"////////////////// ListenThreadWorker Spaceship_id: {spaceship_id}")
                    print(f"//////////////////ListenThreadWorker Bullet_id: {bullet_id}")
                    ...
                    #print(f"000000000000000000000000000000000000000000Ovo je scoreIndex= {scoreIndex}, a ovo value={scoreValue}")
