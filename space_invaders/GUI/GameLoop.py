        ...
        if len(self.hearts) == 0:
            ...
            if (luckyFactor == 1):
                ...
                if (len(self.hearts) == 1):
                    ...
                    heart = HeartFactory.create_object(self, "heart_id",  40, 560, "../Sources/Images/Player/life.png", 40,
                                               40, "player_id")
                    print("KREIRANO SRCULENCE")
                    self.hearts.append(heart)
                elif len(self.hearts) == 2:
                    print("KREIRAM SRCULENCE")
                    heart = HeartFactory.create_object(self, "heart_id", 2 * 40, 560, "../Sources/Images/Player/life.png", 40,
                                               40, "player_id")
                    print("KREIRANO SRCULENCE")
                    self.hearts.append(heart)
